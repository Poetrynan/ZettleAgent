...
pipeline_log::init(&app_data_dir);
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            // 图谱计划：目标→观察→提议→预览→提交→验证→撤销。
            commands::knowledge_graph_create_plan,
            commands::knowledge_graph_get_plan,
            commands::knowledge_graph_stage_plan,
            commands::knowledge_graph_commit_plan,
            commands::knowledge_graph_rollback_plan,
            commands::knowledge_graph_verify_plan,
            commands::knowledge_graph_relation_evidence,
            commands::knowledge_graph_decide_relation,
            commands::knowledge_graph_create_moc_draft,
            // 画布计划：目标→观察→提议→预览→部分批准→提交→验证→撤销。
            commands::knowledge_canvas_create_plan,
            commands::knowledge_canvas_get_plan,
            commands::knowledge_canvas_stage_plan,
            commands::knowledge_canvas_commit_plan,
            commands::knowledge_canvas_rollback_plan,
            commands::knowledge_canvas_verify_plan,
