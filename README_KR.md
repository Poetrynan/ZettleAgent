<div align="center">
  ...
  ### AI 기반 Zettelkasten 데스크톱 에이전트

  *생각하고, 모순을 발견하고, 노트를 진화시키는 두 번째 두뇌.*  
...
> ### 🚀 [Releases에서 다운로드](https://github.com/Poetrynan/ZettleAgent/releases) → 설치 → 바로 사용
> 
> Node.js, Docker, 추가 모델 다운로드 불필요. 약 300MB 설치 패키지에 nomic 임베딩 모델, ONNX Runtime WASM, PP-OCR이 포함되어 있으며, 설치 후 완전 오프라인으로 로컬 Markdown 폴더에서 작동합니다.
